      ...
      <div className="mx-3 md:container md:mx-auto my-5 rounded-xl p-5 bg-violet-100 min-h-[80vh] md:w-1/2">
        ...
        <div className="addTodo my-5 flex flex-col gap-4">
          ...
          <div className="flex">
            ...
            <button onClick={hangleAdd} disabled={todo.length <= 3} className='bg-violet-800 hover:bg-violet-950 disabled:bg-violet-700 p-4 py-2 text-sm font-bold text-white mx-2 rounded-full'>Save</button>
          </div>
        </div>
        <div>
          <input type="checkbox" className='my-4' checked={showFinished} onChange={toggleFinished} name="" id="show" /> 
